...
uniform vec4 mycolor;//this is for the color of the uniform grid
...
//  if(mycolor!=0)// this is for the color of the uniform grid
//     out_color = mycolor;
...
//   else
//     out_color = color;// this is for the shading of the 1st big cube
