...
//            printf("%i/", objData->textureList [objData->faceList[i]->texture_index[j]]->e[0] );
//            printf("%i/", objData->textureList [objData->faceList[i]->texture_index[j]]->e[1] );
